        ...
        public partial class TaskInfo : ITaskInfo
        {
            ...
            internal static TaskTypes GetType(MapTypes map, uint taskId)
            {
                return map switch
                {
                    ...
                    MapTypes.Airship => taskId switch
                    {
                        0 => TaskTypes.AirshipElectricalFixWiring,
                        1 => TaskTypes.AirshipMeetingRoomEnterIDCode,
                        2 => TaskTypes.AirshipResetBreakers,
                        3 => TaskTypes.AirshipUNKNOWN,
                        4 => TaskTypes.AirshipVaultUploadData,
                        5 => TaskTypes.AirshipBrigUploadData,
                        6 => TaskTypes.AirshipCargoBayUploadData,
                        7 => TaskTypes.AirshipGapRoomUploadData,
                        8 => TaskTypes.AirshipRecordsUploadData,
                        9 => TaskTypes.AirshipCargoBayUnlockSafe,
                        10 => TaskTypes.AirshipVentilationStartFans,
                        11 => TaskTypes.AirshipMainHallEmptyGarbage,
                        12 => TaskTypes.AirshipMedicalEmptyGarbage,
                        13 => TaskTypes.AirshipKitchenEmptyGarbage,
                        14 => TaskTypes.AirshipMainHallDevelopPhotos,
                        15 => TaskTypes.AirshipCargoBayFuelEngines,
                        16 => TaskTypes.AirshipSecurityRewindTapes,
                        17 => TaskTypes.AirshipVaultPolishRuby,
                        18 => TaskTypes.AirshipElectricalCalibrateDistributor,
                        19 => TaskTypes.AirshipStabilizeSteering,
                        20 => TaskTypes.AirshipArmoryUploadData,
                        21 => TaskTypes.AirshipCockpitUploadData,
                        22 => TaskTypes.AirshipCommunicationsUploadData,
                        23 => TaskTypes.AirshipMedicalUploadData,
                        24 => TaskTypes.AirshipViewingDeckUploadData,
                        25 => TaskTypes.AirshipArmoryDivertPower,
                        26 => TaskTypes.AirshipCockpitDivertPower,
                        27 => TaskTypes.AirshipGapRoomDivertPower,
                        28 => TaskTypes.AirshipMainHallDivertPower,
                        29 => TaskTypes.AirshipMeetingRoomDivertPower,
                        30 => TaskTypes.AirshipShowersDivertPower,
                        31 => TaskTypes.AirshipEngineRoomDivertPower,
                        32 => TaskTypes.AirshipShowersPickUpTowels,
                        33 => TaskTypes.AirshipLoungeCleanToilet,
                        34 => TaskTypes.AirshipVaultDressMannequin,
                        35 => TaskTypes.AirshipRecordsSortRecords,
                        36 => TaskTypes.AirshipArmoryPutAwayPistols,
                        37 => TaskTypes.AirshipArmoryPutAwayRifles,
                        38 => TaskTypes.AirshipMainHallDecontaminate,
                        39 => TaskTypes.AirshipKitchenMakeBurger,
                        40 => TaskTypes.AirshipShowersFixShower,
                        _ => throw new ArgumentException($"Invalid task id {taskId} for map {map}"),
                    },
                    _ => throw new ArgumentException($"Invalid task id {taskId} for map {map}"),
                };
